...
jQuery(function(){
  ...
  jQuery("#wcButton").hover(function(){
    jQuery(this).addClass("wcButtonHover");
  },function(){
    jQuery(this).removeClass("wcButtonHover");
  });
  jQuery("#moveButton").bind("click.on", dragMe);
  jQuery("#moveButton").hover(function(){
    jQuery(this).addClass("moveButtonHover");
  },function(){
    jQuery(this).removeClass("moveButtonHover");
  });
  jQuery("#zoomButton").bind("click.on", zoomOnOff);
  jQuery("#zoomButton").hover(function(){
    jQuery(this).addClass("zoomButtonHover");
  },function(){
    jQuery(this).removeClass("zoomButtonHover");
  });
});
...
function hidePatient(){
  if(hidepatient==0){
    ...
    new Effect.SlideDown('patientDiv',{
      duration:1.0
    });
...
function load()
{
  ...
  // was numberOfImages
  var numItem = jQuery("#thumbNailHolder .scale-item").length;
...
function changeSpeed1(ft) {
  ...
  cineSlider.dispose();
  cineSlider = new Control.Slider('cineHandle','cineTrack',{
    axis:'horizontal',
    minimum:100,
    maximum:1000,
    alignX:00,
...
function enableMeasure() {
  ...
  jQuery("#measureButton").hover(function(){
    jQuery(this).addClass("measureButtonHover");
  },function(){
    jQuery(this).removeClass("measureButtonHover");
  });
...
function loadImageCache(img, numberOfFrames){
  ...
  jQuery('#imageCacheHolder').empty().append(jQuery.jqote(imageCacheTemplate, {
    src:img,
...
function searchButtonClicked() {
  ...
  new Effect.SlideDown('searchPane',{
    duration:0.5
  });
...
function showStudy(patid, studyid, patname)
{
  hidePatient();
  hidesereis=1;
  hideSeries();
  document.getElementById("imagePane").innerHTML="";
  ajaxpage("seriesPane", "SeriesInfo.jsp?patient="+patid+"&study="+studyid);
  resetLoop();
  setPatientInfoVisible(patname);
}

function clearSerie1(imgno, patname)
{
  hidesereis=1;
  directSeries=1;
  initScroll();
...
function clearSerie2(imgno, patname)
{
  document.getElementById("seriesPane").innerHTML="";
  hidesereis=0;
  directSeries=1;
  hideSeries();
  hidePatient();
