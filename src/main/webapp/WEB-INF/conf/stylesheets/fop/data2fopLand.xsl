  ...
  <xsl:template match="data">
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:layout-master-set>
        <fo:simple-page-master master-name="page-A4-landscape"
                               page-width="29.7cm"
                               page-height="21cm"
                               margin-top="1cm"
                               margin-bottom="1cm"
        ...
        <fo:page-sequence-master master-name="all">
          <fo:repeatable-page-master-alternatives>
            <fo:conditional-page-master-reference master-reference="page-A4-landscape"/>
          </fo:repeatable-page-master-alternatives>
          ...
          <fo:block font-size="8pt" font-family="sans-serif" border="solid black 1pt">
            <fo:table>
              ...
              <!-- calcola la dimensione della colonna in millimetri:
                  ...
                  size * 287 dove 287 e' la larghezza in mm dell'area
                  utile sul foglio -->
                  <xsl:attribute name="column-width"><xsl:value-of select="number(@size) * 287.0"/>mm</xsl:attribute>
      ...
      <fo:table>
        ...
        <xsl:for-each select="hfld/fld">
          ...
          <!-- calcola la dimensione della colonna in millimetri:
               ...
               (width * 287)/100 dove 287 e' la larghezza in mm dell'area
               utile sul foglio -->
            <xsl:attribute name="column-width">
              <xsl:value-of select="number(@WIDTH) * 2.87"/>mm
            </xsl:attribute>
            <xsl:value-of select="name"/>
          </xsl:element>
        </xsl:for-each>
