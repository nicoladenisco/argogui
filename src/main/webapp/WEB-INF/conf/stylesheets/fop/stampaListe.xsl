...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsp-request="http://apache.org/xsp/request/2.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
	<xsl:template match="data">
		<fo:root>
			<fo:layout-master-set>
				<fo:simple-page-master master-name="page-A4" page-height="21cm" page-width="29.7cm" margin-top="1cm" margin-bottom="1cm" margin-left="0.5cm" margin-right="0.5cm">
			...
			<fo:page-sequence master-reference="all">
				<fo:static-content flow-name="xsl-region-before">
					<fo:block text-align="center" font-size="26pt" font-family="serif" line-height="24pt">
						<xsl:value-of select="header"/>
					</fo:block>
					<fo:block text-align="center" font-size="14pt" font-family="serif" line-height="14pt">
						<xsl:value-of select="titolo"/>
					</fo:block>
				</fo:static-content>
				<fo:static-content flow-name="xsl-region-after">
					<fo:block text-align="center" font-size="10pt" font-family="serif" line-height="14pt">Pagina <fo:page-number/></fo:block>
				</fo:static-content>
	...
	<xsl:template match="records">
		<fo:block font-size="8pt" font-family="sans-serif" border="solid black 1pt">
			<fo:table>
				<xsl:for-each select="fields/fld">
               ...
               utile sul foglio -->
						<xsl:attribute name="column-width"><xsl:value-of select="number(@WIDTH) * 2.0"/>mm</xsl:attribute>
	...
	<xsl:template match="para-pre">
		<fo:block font-size="12pt" font-family="courier" space-before.optimum="12pt" text-align="left">
			<xsl:apply-templates/>
		</fo:block>
	</xsl:template>
	<xsl:template match="content">
