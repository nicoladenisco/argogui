...
>
   ...
   <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<fo:block text-align="center"
	 ...
	 <xsl:value-of select="titolo"/>
        ...
        <fo:block font-size="6pt" font-family="sans-serif" border="solid black 1pt">
        <fo:table>
	...
	<fo:block text-align="center"
	          font-size="10pt"
		  font-family="serif"
		  line-height="14pt">Pagina <fo:page-number/></fo:block>
      </fo:static-content>
  ...
  <xsl:template match="group">
    <fo:block font-size="6pt" font-family="sans-serif" border="solid black 4pt">
      <xsl:apply-templates/>
    </fo:block>
  </xsl:template>
